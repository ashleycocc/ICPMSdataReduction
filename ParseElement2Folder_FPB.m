...
datafolderstring = './data/12022018_AC_UThFPB/';
...
for iMass1x = 11:21
    ...
    sampData(iMass1x).stdError232Th229Th = (sqrt((mean(std(sampData(iMass1x).massFracCorr232Th229Th)...
        ...
        + (stdData(iMass1x-7).U238U235FracUncert^2))) * sampData(iMass1x).avgMassFracCorr232Th229Th;
    ...
    sampData(iMass1x).stdError238U235U = (sqrt((mean(std(sampData(iMass1x).massFracCorr238U235U)...
        ...
        + (stdData(iMass1x-7).U238U235FracUncert^2))) * sampData(iMass1x).avgMassFracCorr238U235U;
