...
datafolderstring = './data/01052019_AC_AcidBlanks/';
...
for iMass = 1:2
    ...
    sampData(iMass).stdError232Th229Th = (sqrt((mean(std(sampData(iMass).massFracCorr232Th229Th)...
        ...
        + (stdData(1).U238U235FracUncert^2))) * sampData(iMass).avgMassFracCorr232Th229Th;
    ...
    sampData(iMass).stdError238U235U = (sqrt((mean(std(sampData(iMass).massFracCorr238U235U)...
        ...
        + (stdData(1).U238U235FracUncert^2))) * sampData(iMass).avgMassFracCorr238U235U;
...
for iMass1x = 3:4
    ...
    sampData(iMass1x).stdError232Th229Th = (sqrt((mean(std(sampData(iMass1x).massFracCorr232Th229Th)...
        ...
        + (stdData(2).U238U235FracUncert^2))) * sampData(iMass1x).avgMassFracCorr232Th229Th;
    ...
    sampData(iMass1x).stdError238U235U = (sqrt((mean(std(sampData(iMass1x).massFracCorr238U235U)...
        ...
        + (stdData(2).U238U235FracUncert^2))) * sampData(iMass1x).avgMassFracCorr238U235U;
...
for iBlank = 1:length(BlankData)
    ...
    BlankData(iBlank).stdError232Th229Th = (sqrt((mean(std(BlankData(iBlank).massFracCorr232Th229Th)...
        ...
        + (stdData(1).U238U235FracUncert^2))) * BlankData(iBlank).avgMassFracCorr232Th229Th;
    ...
    BlankData(iBlank).stdError238U235U = (sqrt((mean(std(BlankData(iBlank).massFracCorr238U235U)...
        ...
        + (stdData(1).U238U235FracUncert^2))) * BlankData(iBlank).avgMassFracCorr238U235U;
